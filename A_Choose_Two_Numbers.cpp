    ...
    */
    ...
    void solve()
    {
        ...
        cin>>n;
        vector<int> a(n);
        vector<bool> prea(402);
        vector<bool> preb(402);
        rep(i,0,402)prea[i]=preb[i]=false;
        rep(i,0,n){cin>>a[i];prea[a[i]]=true;}
        int m;
        cin>>m;
        vector<int> b(m);
        rep(i,0,m){cin>>b[i];preb[b[i]]=true;}
        rep(i,0,n){
            rep(j,0,m){
                if((prea[a[i]+b[j]]==false)&&(preb[a[i]+b[j]]==false)){
                    cout<<a[i]<<" "<<b[j]<<endl;
                    return; 
                }
            }
